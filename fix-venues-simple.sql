...
-- Add sample venues if table is empty
INSERT INTO venues (name, type, city, price, rating, reviews, image, amenities, capacity, description, owner_id)
SELECT 
